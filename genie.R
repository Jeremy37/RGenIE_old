...
main = function() {
  ...
  option_list <- list(
    ...
    make_option(c("--grep_analysis"), type="logical", default=T, action="store_true", help="Run simple grep analysis [default %default]"),
    make_option(c("--grep_window"), type="integer", default=10, metavar="INT", help="Window around HDR/WT allele sites to require sequence match [default %default]"),
    make_option(c("--grep_window_left"), type="integer", default=NULL, metavar="INT", help="Window to left of HDR/WT allele sites to require sequence match, ignored if < 0 [default %default]"),
    make_option(c("--grep_window_right"), type="integer", default=NULL, metavar="INT", help="Window to right of HDR/WT allele sites to require sequence match, ignored if < 0 [default %default]"),
    make_option(c("--deletion_analysis"), type="logical", default=T, action="store_true", help="Run deletion profile analysis [default %default]"),
    ...
    make_option(c("--editing_window"), type="integer", default=20, metavar="INT", help="[default %default]"),
